import { colorToRgb, getDistance, getDistances, getRangeValue, getStyleFromRgb, getValue, isPointInside, } from "../../Utils";
    ...
    updateParticlePosition(particle, v) {
        ...
        if (this.options.orbits) {
            ...
            particle.orbit.angle +=
                (((_a = particle.moveSpeed) !== null && _a !== void 0 ? _a : getRangeValue(particle.options.move.speed) * this.container.retina.pixelRatio) /
                    100) *
